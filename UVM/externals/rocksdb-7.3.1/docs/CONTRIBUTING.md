...
- Review the [template information](CLionProjects/UVM/externals/rocksdb-7.3.1/docs/TEMPLATE-INFORMATION.md).
- Review `./_config.yml`.
...
1. [Run the site locally](CLionProjects/UVM/externals/rocksdb-7.3.1/docs/README.md) to test your changes. It will be at `http://127.0.0.1/blog/your-new-blog-post-title.html`
...
1. [Run the site locally](CLionProjects/UVM/externals/rocksdb-7.3.1/docs/README.md) to test your changes. It will be at `http://127.0.0.1/docs/your-new-doc-permalink.html`
1. Push your changes to GitHub.
...
1. [Run the site locally](CLionProjects/UVM/externals/rocksdb-7.3.1/docs/README.md) to test your changes. It will be at `http://127.0.0.1/your-top-level-page-permalink.html`
1. Push your changes to GitHub.
