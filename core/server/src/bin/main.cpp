...
private:
    ...
    bool valid_token_name(const std::string &token_name)
    {
        return true;
    }
        ...
        case http::verb::post:
            ...
            try
            {
                ...
                if (type == 0)
                {
                    ...
                    fl = (data["amount"] != nullptr && // nullptr выдает тогда, когда поля "amount" нет.
                          data["to"] != nullptr &&
                          data["from"] != nullptr &&
                ...
                else if (type == 2)
                {
                    ...
                    std::string bytecode_string = hex_to_ascii((std::string)data["extradata"]["bytecode"]);
