...
#if defined(OS_WIN)
#include <Windows.h>
    std::string kDBPath = "C:\\Windows\\TEMP\\unit";
...
#include <unistd.h>
#include <thread>
std::string kDBPath = "/home/unit";
const char DBPath[] = "/home/unit";
const int cpus = (int) std::thread::hardware_concurrency();
#endif
std::string column_families[] = {"block_tx", "address_contracts", "tx", "height", "account_balance"};
#endif //UVM_ENV_H
