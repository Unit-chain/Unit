...
struct ColumnFamilyOptions : public AdvancedColumnFamilyOptions {
  ...
  // https://github.com/facebook/wiki/Rocksdb-Architecture-Guide
...
struct DBOptions {
  ...
  // https://github.com/facebook/wiki/Column-Families
  //
  ...
  // (https://github.com/facebook/wiki/Single-Delete) is not enforced,
