//
// Created by Kirill Zhukov on 28.10.2022.
//

#ifndef UNIT_THREADPOOL_H
#define UNIT_THREADPOOL_H
#include "iostream"
#include "queue"
#include "thread"
#include "chrono"
...
public:
    ...
    [[nodiscard]] std::any get_result() const {
        return (!is_void && any_func_result.has_value());
    }
private:
...
#endif //UNIT_THREADPOOL_H


#if 0
// https://github.com/skprpi/Habr/tree/main/thread_pool#кто-такой-thread-pool
#include <iostream>
#include <queue>
#include <thread>
#include <chrono>
