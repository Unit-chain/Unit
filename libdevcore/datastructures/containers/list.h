...
namespace unit {
    ...
    public:
        ...
        list( const unit::list<T, Allocator> & x ) { boost::lock_guard<boost::mutex> lock(x.mutex ); storage = x.storage; }

        //Copy
        unit::list<T,Allocator>& operator=(const unit::list<T,Allocator>& x ) { boost::lock_guard<boost::mutex> lock(mutex ); boost::lock_guard<boost::mutex> lock2(x.mutex ); storage = x.storage; return *this;}
        ...
        void swap(unit::list<T, Allocator> & x ) { boost::lock_guard<boost::mutex> lock(mutex ); boost::lock_guard<boost::mutex> lock2(x.mutex ); storage.swap(x.storage ); }

        void clear( void ) { boost::lock_guard<boost::mutex> lock( mutex ); storage.clear(); }

        //Operations
        void splice (iterator position, unit::list<T,Allocator>& x ) { boost::lock_guard<boost::mutex> lock(mutex ); boost::lock_guard<boost::mutex> lock2(x.mutex ); storage.splice(position, x.storage ); }
        void splice (iterator position, unit::list<T,Allocator>& x, iterator i ) { boost::lock_guard<boost::mutex> lock(mutex ); boost::lock_guard<boost::mutex> lock2(x.mutex ); storage.splice(position, x.storage, i ); }
        void splice (iterator position, unit::list<T,Allocator>& x, iterator first, iterator last ) { boost::lock_guard<boost::mutex> lock(mutex ); boost::lock_guard<boost::mutex> lock2(x.mutex ); storage.splice(position, x.storage, first, last ); }
        ...
        void merge (unit::list<T,Allocator>& x ) { boost::lock_guard<boost::mutex> lock(mutex ); boost::lock_guard<boost::mutex> lock2(x.mutex ); storage.merge(x.storage() ); }
        template <class Compare> void merge (unit::list<T,Allocator>& x, Compare comp ) { boost::lock_guard<boost::mutex> lock(mutex ); boost::lock_guard<boost::mutex> lock2(x.mutex ); storage.merge(x.storage, comp ); }
