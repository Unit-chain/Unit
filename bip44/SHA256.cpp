...
/// process 64 bytes
void SHA256_Legacy::processBlock(const void* data)
{
    // get last hash
    uint32_t a = m_hash[0];
    uint32_t b = m_hash[1];
...
void SHA256_Legacy::add(const void* data, size_t numBytes)
{
...
void SHA256_Legacy::processBuffer()
{
...
std::string SHA256_Legacy::getHash()
{
...
void SHA256_Legacy::getHash(unsigned char buffer[SHA256_Legacy::HashBytes])
{
...
std::string SHA256_Legacy::operator()(const void* data, size_t numBytes)
{
    reset();
    add(data, numBytes);
    return getHash();
...
std::string SHA256_Legacy::operator()(const std::string& text)
{
    reset();
