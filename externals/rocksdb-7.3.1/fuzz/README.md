...
see [proto/db_operation.proto](CLionProjects/UVM/externals/rocksdb-7.3.1/fuzz/proto/db_operation.proto) for details.

### Define tests with the input

In [sst_file_writer_fuzzer.cc](CLionProjects/UVM/externals/rocksdb-7.3.1/fuzz/sst_file_writer_fuzzer.cc),
